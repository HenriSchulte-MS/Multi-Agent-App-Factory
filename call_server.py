...
TARGET_TEAMS_USER_ID = os.getenv("TARGET_TEAMS_USER_ID")

TEMPLATE_FILES_PATH = os.getenv("TEMPLATE_FILES_PATH", "templates")
...
class CallServer:
    def __init__(self):
        self.start_message = "Hello, this is an AI assistant. How can I help you today?"
        self.end_message = "Thank you for your response. Goodbye."
    ...
    def make_call(self, start_message: str, end_message: str):
        ...
        self.app.logger.info("Created call with connection id: %s", call_connection_id)
    ...
    def callback_events_handler(self):
        for event_dict in request.json:
            ...
            self.app.logger.info("%s event received for call connection id: %s", 
            ...
            if event.type == "Microsoft.Communication.CallConnected":
                self.app.logger.info("Starting recognize")
                ...
                self.app.logger.info("Recognize completed: data=%s", event.data)

                if event.data['recognitionType'] == "speech":
                    text = event.data['speechResult']['speech']
                    self.app.logger.info("Recognition completed, text=%s", text)
                ...
                self.app.logger.info("Recognition failed, terminating call")
                ...
                self.app.logger.info("Terminating call")
